...
class EmailService:
    ...
    def send_email(self, to_email: str, subject: str, body: str, 
                   html_body: Optional[str] = None, attachments: Optional[Dict] = None) -> Tuple[bool, str]:
        """
        ...
        for attempt in range(self.config.max_retries):
            success, message = self._send_email_attempt(to_email, subject, body, html_body, attachments)
            ...
            # Log failed attempt
            logger.warning(f"Email failed for {to_email} (attempt {attempt + 1}/{self.config.max_retries}): {message}")
    ...
    def _send_email_attempt(self, to_email: str, subject: str, body: str,
                           html_body: Optional[str], attachments: Optional[Dict]) -> Tuple[bool, str]:
        """
    ...
    def get_delivery_status(self, to_email: str) -> Optional[Dict]:
        """
