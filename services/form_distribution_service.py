...
class FormDistributionService:
    ...
    def __init__(self, forms_filepath: str = "forms.json", 
    ...
    def create_form_for_appointment(self, appointment_id: str, patient_id: str,
                                   ...
                                   doctor: str, appointment_date: str,
        ...
        try:
            ...
            logger.info(f"Created form for appointment {appointment_id} with token {form_token[:8]}...")
    ...
    def send_form_email(self, appointment_id: str, patient_email: str,
                       patient_name: str) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if success:
                ...
                # Log delivery
                self._log_delivery(
                    appointment_id, patient_email, 'sent',
...
<body>
    ...
    def mark_form_completed(self, appointment_id: str, form_data: Optional[Dict] = None) -> Tuple[bool, str]:
        """
    ...
    def get_form_status(self, appointment_id: str) -> Optional[Dict]:
        """
    ...
    def send_form_reminder(self, appointment_id: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if success:
                self._log_delivery(
                    appointment_id, form['patient_email'], 'reminder_sent',
...
<body>
    ...
    def _load_forms(self) -> Dict:
        ...
        try:
            if os.path.exists(self.forms_filepath):
                with open(self.forms_filepath, 'r') as f:
                    return json.load(f)
        except Exception as e:
    ...
    def _load_delivery_log(self) -> Dict:
        ...
        try:
            if os.path.exists(self.delivery_log_filepath):
                with open(self.delivery_log_filepath, 'r') as f:
                    return json.load(f)
        except Exception as e:
    ...
    def _log_delivery(self, appointment_id: str, email: str, 
...
_form_distribution_service: Optional[FormDistributionService] = None
