...
class PromptLoader:
    ...
    def get_section(self, prompt_name: str, section: str) -> str:
        ...
        if section_marker not in full_prompt:
            ...
            for prefix in ['[PROMPT:', '[FEEDBACK:', '[ERROR:', '[STATUS:', 
                          '[MESSAGE:', '[NOTE:', '[DISPLAY:', '[WARNING:']:
    ...
    def get_prompt_text(self, prompt_name: str, item_name: str) -> str:
        ...
        for prefix in ['[PROMPT:', '[FEEDBACK:', '[ERROR:', '[STATUS:', 
                      '[MESSAGE:', '[NOTE:', '[WARNING:', '[SUCCESS:', '[DISPLAY:']:
    ...
    def get_section_safe(self, prompt_name: str, section: str, 
    ...
    def get_prompt_text_safe(self, prompt_name: str, item_name: str,
                            default: Optional[str] = None) -> str:
        """
...
def get_prompt_text_safe(prompt_name: str, item_name: str,
                         default: Optional[str] = None) -> str:
...
def get_section_safe(prompt_name: str, section: str,
                     default: Optional[str] = None) -> str:
